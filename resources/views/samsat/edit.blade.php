            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">{{ __('Ubah Samsat') }}</h2>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form form-horizontal" action="{{ route('samsat.update', $samsat->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" id="uptd_gerai"
                                                            ...
                                                            value="{{ old('uptd_gerai') ?? $samsat->uptd_gerai }}" />
                                                        @error('uptd_gerai')
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" id="wilayah"
                                                            ...
                                                            value="{{ old('wilayah') ?? $samsat->wilayah }}" />
                                                        @error('wilayah')
                                                            <div class="invalid-feedback" role="alert">
                                                                {{ $message }}
                                                            </div>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" cols="30"
                                                            rows="3" placeholder="{{ __('Alamat') }}">{{ old('alamat') ?? $samsat->alamat }}</textarea>
                                                        @error('alamat')
                                                            <div class="invalid-feedback" role="alert">
                                                                {{ $message }}
                                                            </div>
