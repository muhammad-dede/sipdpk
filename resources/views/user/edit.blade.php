            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">{{ __('Ubah User') }}</h2>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form form-horizontal" action="{{ route('user.update', $user->uuid) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                                        ...
                                                        <select name="role" id="role"
                                                            ...
                                                            @foreach ($data_role as $item)
                                                                <option value="{{ $item->name }}"
                                                                    {{ old('role') ?? $user_role == $item->name ? 'selected' : '' }}>
                                                                    {{ $item->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
