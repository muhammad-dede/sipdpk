...
@section('title', __('Daftar Pertelaan Arsip'))
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">{{ __('Daftar Pertelaan Arsip') }}</h2>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header border-bottom d-flex justify-content-between">
                                    ...
                                    <a href="{{ route('dpa.create') }}" class="btn btn-primary">{{ __('Tambah') }}</a>
                                </div>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <form action="{{ route('dpa.destroy', $item->id) }}"
