...
@section('title', __('Ubah Record Centre'))
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">{{ __('Ubah Record Centre') }}</h2>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form form-horizontal" action="{{ route('rc.update', $rc->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                                        ...
                                                        <select name="id_stnk" class="select2 form-select" id="id_stnk">
                                                            ...
                                                            @foreach ($data_stnk as $item)
                                                                <option value="{{ $item->id }}"
                                                                    {{ old('id_stnk') ?? $rc->id_stnk == $item->id ? 'selected' : '' }}>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" id="tgl_akhir_pkb"
                                                            ...
                                                            value="{{ old('tgl_akhir_pkb') ?? date('Y-m-d', strtotime($rc->tgl_akhir_pkb)) }}" />
                                                        @error('tgl_akhir_pkb')
