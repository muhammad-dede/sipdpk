            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">{{ __('Ubah STNK') }}</h2>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form form-horizontal" action="{{ route('stnk.update', $stnk->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" cols="30"
                                                            rows="3" placeholder="{{ __('Alamat') }}">{{ old('alamat') ?? $stnk->alamat }}</textarea>
                                                        @error('alamat')
                                                            <div class="invalid-feedback" role="alert">
                                                                {{ $message }}
                                                            </div>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" id="tgl_awal_pkb"
                                                            ...
                                                            value="{{ old('tgl_awal_pkb') ?? date('Y-m-d', strtotime($stnk->tgl_awal_pkb)) }}" />
                                                        @error('tgl_awal_pkb')
                                                            <div class="invalid-feedback" role="alert">
                                                                {{ $message }}
                                                            </div>
                                                        ...
                                                        <select name="id_samsat" class="select2 form-select" id="id_samsat">
                                                            ...
                                                            @foreach ($data_samsat as $item)
                                                                <option value="{{ $item->id }}"
                                                                    {{ old('id_samsat') ?? $stnk->id_samsat == $item->id ? 'selected' : '' }}>
