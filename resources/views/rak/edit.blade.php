            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">{{ __('Ubah RAK') }}</h2>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form form-horizontal" action="{{ route('rak.update', $rak->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                                        ...
                                                        <select name="id_lokasi" class="select2 form-select" id="id_lokasi">
                                                            ...
                                                            @foreach ($data_lokasi as $item)
                                                                <option value="{{ $item->id }}"
                                                                    {{ old('id_lokasi') ?? $rak->id_lokasi == $item->id ? 'selected' : '' }}>
                                                                    {{ $item->nama }}
                                                                </option>
                                                            @endforeach
                                                        </select>
